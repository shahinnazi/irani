...
import com.shahin.iran.AgeWidget
import com.shahin.iran.BuildConfig
import com.shahin.iran.DEFAULT_SELECTED_WIDGET_BACKGROUND_COLOR
import com.shahin.iran.DEFAULT_SELECTED_WIDGET_TEXT_COLOR
import com.shahin.iran.IRAN_TIMEZONE_ID
...
import com.shahin.iran.NON_HOLIDAYS_EVENTS_KEY
import com.shahin.iran.OTHER_CALENDARS_KEY
import com.shahin.iran.OWGHAT_KEY
import com.shahin.iran.OWGHAT_LOCATION_KEY
import com.shahin.iran.PREF_SELECTED_DATE_AGE_WIDGET
import com.shahin.iran.PREF_SELECTED_DATE_AGE_WIDGET_START
import com.shahin.iran.PREF_SELECTED_WIDGET_BACKGROUND_COLOR
import com.shahin.iran.PREF_SELECTED_WIDGET_TEXT_COLOR
import com.shahin.iran.PREF_TITLE_AGE_WIDGET
import com.shahin.iran.R
import com.shahin.iran.Widget1x1
import com.shahin.iran.Widget2x2
import com.shahin.iran.Widget4x1
import com.shahin.iran.Widget4x2
import com.shahin.iran.WidgetMap
import com.shahin.iran.WidgetMonth
import com.shahin.iran.WidgetMonthView
import com.shahin.iran.WidgetMoon
import com.shahin.iran.WidgetSchedule
import com.shahin.iran.WidgetSunView
import com.shahin.iran.entities.CalendarEvent
import com.shahin.iran.entities.Clock
import com.shahin.iran.entities.DeviceCalendarEventsStore
...
import com.shahin.iran.global.clockIn24
import com.shahin.iran.global.coordinates
import com.shahin.iran.global.eventsRepository
import com.shahin.iran.global.isCenterAlignWidgets
import com.shahin.iran.global.isForcedIranTimeEnabled
import com.shahin.iran.global.isHighTextContrastEnabled
import com.shahin.iran.global.isNotifyDate
import com.shahin.iran.global.isNotifyDateOnLockScreen
import com.shahin.iran.global.isShowDeviceCalendarEvents
import com.shahin.iran.global.isShowWeekOfYearEnabled
import com.shahin.iran.global.isTalkBackEnabled
import com.shahin.iran.global.isWidgetClock
import com.shahin.iran.global.language
import com.shahin.iran.global.loadLanguageResources
import com.shahin.iran.global.mainCalendar
import com.shahin.iran.global.mainCalendarDigits
import com.shahin.iran.global.prefersWidgetsDynamicColorsFlow
import com.shahin.iran.global.secondaryCalendar
import com.shahin.iran.global.spacedComma
import com.shahin.iran.global.whatToShowOnWidgets
import com.shahin.iran.global.widgetTransparency
import com.shahin.iran.service.BroadcastReceivers
import com.shahin.iran.service.ScheduleWidgetService
import com.shahin.iran.service.widgetWidthCellKey
import com.shahin.iran.ui.MainActivity
import com.shahin.iran.ui.astronomy.AstronomyState
import com.shahin.iran.ui.calendar.calendarpager.DayPainter
import com.shahin.iran.ui.calendar.calendarpager.MonthColors
import com.shahin.iran.ui.calendar.calendarpager.renderMonthWidget
import com.shahin.iran.ui.calendar.eventTextColor
import com.shahin.iran.ui.calendar.sortEvents
import com.shahin.iran.ui.calendar.times.SunView
import com.shahin.iran.ui.calendar.times.SunViewColors
import com.shahin.iran.ui.common.SolarDraw
import com.shahin.iran.ui.map.MapDraw
import com.shahin.iran.ui.map.MapType
import com.shahin.iran.ui.resumeToken
import com.shahin.iran.ui.settings.agewidget.AgeWidgetConfigureActivity
import com.shahin.iran.ui.utils.dp
import com.shahin.iran.ui.utils.isLandscape
import com.shahin.iran.ui.utils.isRtl
import com.shahin.iran.ui.utils.isSystemInDarkTheme
...
private const val NOTIFICATION_ID_DEFAULT_PRIORITY = 1001
private const val NOTIFICATION_ID_LOW_PRIORITY = 1003
...
var latestFiredUpdate: Long = 0 // Initialize to avoid uninitialized variable issues
// Track the previous notification data for comparison
private var previousNotificationData: NotificationData? = null
private var latestPostedNotification: NotificationCompat.Builder? = null // Declare as a property
...
fun update(context: Context,
    ...
    val notificationData = NotificationData(
        ...
        date = date,
        prayTimes = prayTimes,
        nextPrayTime = prayTimes?.getNextPrayTime(clock),
        timesToShow = if (prayTimes != null && OWGHAT_KEY in whatToShowOnWidgets) timesToShow(clock, prayTimes) else null,
        ...
        notificationId = NOTIFICATION_ID_DEFAULT_PRIORITY // Use 1001 for foreground
    )
    ...
    val builder = NotificationCompat.Builder(context, "1001")
        ...
        .setStyle(NotificationCompat.BigTextStyle().bigText(owghat))
        .setSmallIcon(getDayIconResource(date.dayOfMonth))
        .setOngoing(true)
        .setContentIntent(context.launchAppPendingIntent()) // Ensure clickable
        .setPriority(NotificationCompat.PRIORITY_DEFAULT)
    latestPostedNotification = builder // Store the builder for updates

    updateNotification(context, title, subtitle, jdn, date, owghat, prayTimes, clock)
    val notification = builder.build() // Build the notification
    onNotificationReady(notification) // Pass the built notification
}
...
private fun updateNotification(
    ...
    val notificationData = NotificationData(
        ...
        spacedComma = spacedComma,
        language = language.value,
        notificationId =NOTIFICATION_ID_DEFAULT_PRIORITY
    )
    // Check if update is needed without direct type comparison
    // Compare with previous state instead of Builder directly
    val shouldUpdate = Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU || // API < 33
            previousNotificationData?.title != notificationData.title ||
            previousNotificationData?.subtitle != notificationData.subtitle ||
            previousNotificationData?.owghat != notificationData.owghat

    if (shouldUpdate) {
        latestPostedNotification?.setContentTitle(notificationData.title)
        latestPostedNotification?.setContentText(notificationData.subtitle)
        latestPostedNotification?.setStyle(NotificationCompat.BigTextStyle().bigText(notificationData.owghat))

        if (notificationData.post(context)) {
            previousNotificationData = notificationData
            val notificationManager = context.getSystemService<NotificationManager>()
            notificationManager?.notify(NOTIFICATION_ID_DEFAULT_PRIORITY, latestPostedNotification?.build() ?: return)
        }
    }
}
...
//        notificationManager.notify(notificationId, latestPostedNotification.build()
        return true
    }
}
