package com.shahin.iran.global
...
import com.shahin.iran.DEFAULT_AM
import com.shahin.iran.DEFAULT_ASCENDING_ATHAN_VOLUME
import com.shahin.iran.DEFAULT_ATHAN_VIBRATION
import com.shahin.iran.DEFAULT_AZERI_ALTERNATIVE_PERSIAN_MONTHS
import com.shahin.iran.DEFAULT_CITY
import com.shahin.iran.DEFAULT_DREAM_NOISE
import com.shahin.iran.DEFAULT_EASTERN_GREGORIAN_ARABIC_MONTHS
import com.shahin.iran.DEFAULT_ENGLISH_GREGORIAN_PERSIAN_MONTHS
import com.shahin.iran.DEFAULT_HIGH_LATITUDES_METHOD
import com.shahin.iran.DEFAULT_HOLIDAY
import com.shahin.iran.DEFAULT_IRAN_TIME
import com.shahin.iran.DEFAULT_ISLAMIC_OFFSET
import com.shahin.iran.DEFAULT_LOCAL_DIGITS
import com.shahin.iran.DEFAULT_NOTIFY_DATE
import com.shahin.iran.DEFAULT_NOTIFY_DATE_LOCK_SCREEN
import com.shahin.iran.DEFAULT_PM
import com.shahin.iran.DEFAULT_PRAY_TIME_METHOD
import com.shahin.iran.DEFAULT_RED_HOLIDAYS
import com.shahin.iran.DEFAULT_SECONDARY_CALENDAR_IN_TABLE
import com.shahin.iran.DEFAULT_THEME_GRADIENT
import com.shahin.iran.DEFAULT_VAZIR_ENABLED
import com.shahin.iran.DEFAULT_WALLPAPER_AUTOMATIC
import com.shahin.iran.DEFAULT_WALLPAPER_DARK
import com.shahin.iran.DEFAULT_WIDGET_CLOCK
import com.shahin.iran.DEFAULT_WIDGET_CUSTOMIZATIONS
import com.shahin.iran.DEFAULT_WIDGET_IN_24
import com.shahin.iran.DEFAULT_WIDGET_TRANSPARENCY
import com.shahin.iran.IRAN_TIMEZONE_ID
import com.shahin.iran.PREF_ALTITUDE
import com.shahin.iran.PREF_APP_LANGUAGE
import com.shahin.iran.PREF_ASCENDING_ATHAN_VOLUME
import com.shahin.iran.PREF_ASR_HANAFI_JURISTIC
import com.shahin.iran.PREF_ASTRONOMICAL_FEATURES
import com.shahin.iran.PREF_ATHAN_NAME
import com.shahin.iran.PREF_ATHAN_VIBRATION
import com.shahin.iran.PREF_AZERI_ALTERNATIVE_PERSIAN_MONTHS
import com.shahin.iran.PREF_CALENDARS_IDS_AS_HOLIDAY
import com.shahin.iran.PREF_CALENDARS_IDS_TO_EXCLUDE
import com.shahin.iran.PREF_CENTER_ALIGN_WIDGETS
import com.shahin.iran.PREF_DREAM_NOISE
import com.shahin.iran.PREF_EASTERN_GREGORIAN_ARABIC_MONTHS
import com.shahin.iran.PREF_ENGLISH_GREGORIAN_PERSIAN_MONTHS
import com.shahin.iran.PREF_GEOCODED_CITYNAME
import com.shahin.iran.PREF_HIGH_LATITUDES_METHOD
import com.shahin.iran.PREF_IRAN_TIME
import com.shahin.iran.PREF_ISLAMIC_OFFSET
import com.shahin.iran.PREF_LATITUDE
import com.shahin.iran.PREF_LOCAL_DIGITS
import com.shahin.iran.PREF_LONGITUDE
import com.shahin.iran.PREF_MAIN_CALENDAR_KEY
import com.shahin.iran.PREF_MIDNIGHT_METHOD
import com.shahin.iran.PREF_NOTIFICATION_ATHAN
import com.shahin.iran.PREF_NOTIFY_DATE
import com.shahin.iran.PREF_NOTIFY_DATE_LOCK_SCREEN
import com.shahin.iran.PREF_NUMERICAL_DATE_PREFERRED
import com.shahin.iran.PREF_OTHER_CALENDARS_KEY
import com.shahin.iran.PREF_PRAY_TIME_METHOD
import com.shahin.iran.PREF_RED_HOLIDAYS
import com.shahin.iran.PREF_SECONDARY_CALENDAR_IN_TABLE
import com.shahin.iran.PREF_SELECTED_LOCATION
...
import com.shahin.iran.PREF_SHOW_DEVICE_CALENDAR_EVENTS
import com.shahin.iran.PREF_SHOW_WEEK_OF_YEAR_NUMBER
import com.shahin.iran.PREF_SWIPE_DOWN_ACTION
import com.shahin.iran.PREF_SWIPE_UP_ACTION
import com.shahin.iran.PREF_SYSTEM_DARK_THEME
import com.shahin.iran.PREF_SYSTEM_LIGHT_THEME
import com.shahin.iran.PREF_THEME
import com.shahin.iran.PREF_THEME_GRADIENT
import com.shahin.iran.PREF_VAZIR_ENABLED
import com.shahin.iran.PREF_WALLPAPER_AUTOMATIC
import com.shahin.iran.PREF_WALLPAPER_DARK
import com.shahin.iran.PREF_WEEK_ENDS
import com.shahin.iran.PREF_WEEK_START
import com.shahin.iran.PREF_WHAT_TO_SHOW_WIDGETS
import com.shahin.iran.PREF_WIDGETS_PREFER_SYSTEM_COLORS
import com.shahin.iran.PREF_WIDGET_CLOCK
import com.shahin.iran.PREF_WIDGET_IN_24
import com.shahin.iran.PREF_WIDGET_TRANSPARENCY
import com.shahin.iran.R
import com.shahin.iran.entities.Calendar
import com.shahin.iran.entities.EventsRepository
...
import com.shahin.iran.generated.citiesStore
import com.shahin.iran.ui.calendar.SwipeDownAction
import com.shahin.iran.ui.calendar.SwipeUpAction
import com.shahin.iran.ui.theme.Theme
import com.shahin.iran.utils.applyAppLanguage
import com.shahin.iran.utils.enableHighLatitudesConfiguration
import com.shahin.iran.utils.getJdnOrNull
import com.shahin.iran.utils.isIslamicOffsetExpired
import com.shahin.iran.utils.logException
import com.shahin.iran.utils.preferences
import com.shahin.iran.utils.scheduleAlarms
import com.shahin.iran.utils.splitFilterNotEmpty
